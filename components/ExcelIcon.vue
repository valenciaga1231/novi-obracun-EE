<template>
    <svg class="icon" :style="{ fill: props.color }" :width="props.width" :height="props.height" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
